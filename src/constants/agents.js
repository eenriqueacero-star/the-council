...
CATALYST STANDARD (Gate 1): Only cite an earnings date or catalyst if you found it via live web search or it appears in the LIVE DATA block. NEVER state an earnings date from memory — if you cannot confirm it live, write "earnings date unconfirmed" in your point and score Gate 1 accordingly. An unconfirmed date does not clear Gate 1.
Output ONLY the raw JSON object — no markdown, no code fences, no reasoning text, no prose before or after: {"stance":"PASS"|"FAIL"|"CAUTION","score":<0-10>,"headline":"<8 words max>","points":["<catalyst + date>","<bull thesis>","<short>"]}` },
